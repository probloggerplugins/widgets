	...
	function wyswietl(postId, dyw) {
		...
		zap2.onload = function() {
			if (zap2.status === 200) {
				...
				if (showImage) dyw2.innerHTML += '<img src="' + obi.o + '">';
