...
(function(nr, skryptSRC) {
	...
	styl.innerHTML = '#' + d + ' div.pbpLabel{margin:3px 5px;' + (display !== 'list' ? 'display:inline-block;' : '') + '} .pbpTC_searchButton{display:inline-flex;align-items:center;position:relative;font-size:' + textSize + 'px;padding:3px 7px;background:#949494;border-width:3px;border-style:outset;border-color:#9e9e9e;border-radius:5px;cursor:pointer;} .pbpTC_searchButton:not(.unactive):hover{background:#b2b2b2;border-color:#bcbcbc;} .pbpTC_searchButton:not(.unactive):active{border-style:inset;padding:5px 5px 1px 9px;} .pbpTC_searchButton.unactive {background:#818181;border:3px solid #818181;cursor:default;color:#5a5a5a;} .pbpTC_searchButton .searchInfo{visibility:hidden;opacity:0;display:inline-block;position:absolute;bottom:calc(100% + 9px);left:calc(50% - 42px);background:#b1b1ff;color:black;border:1px solid #00009d;transition:opacity 1s;width:70px;border-radius:7px;padding:3px 7px 1px 7px;text-align:center;font-size:13px;font-weight:normal;line-height:1.2;} .pbpTC_searchButton:hover .searchInfo{visibility:visible;opacity:1;transition:opacity 1s;} .pbpTC_searchButton .searchInfo:hover{visibility:hidden;opacity:0;} .pbpTC_searchButton .searchInfo:after {content:"";display:inline-block;position:absolute;left:calc(50% - 6px);top:100%;border-width:6px;border-style:solid;border-color:transparent;border-top:6px solid #00009d;} .pbpTC_searchButton svg{height:' + textSize + 'px;margin-left:4px;fill:black;fill:currentColor;}';
